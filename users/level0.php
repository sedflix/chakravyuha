...
$level_no = 0;
$correctAns = "74a35f25c70fa7fda841a09fa4754530caf7e7e40126202b396dafb6f5ff775f";
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12"> </br>
                        ...
                        <!---->
                        <!---->
                        <!--NSA loves you. To infinity and beyond.-->
                        <!---->
                        <!---->
                        <!---->
                        <!---->
...
if ($level_no == $row['level']) {
    ?>
    <form action="level0.php" method="post" style="z-index: 999999999; width: 100%; position: absolute;">
        <label>
