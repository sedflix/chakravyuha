            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12"> </br>
                        ...
                        <h1 class="text-center">уровень 7</h1>
                        ...
                        <p class="text-center">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/fe/Emblem_of_Roskomnadzor.svg/490px-Emblem_of_Roskomnadzor.svg.png" class="img-responsive center-block" height="400px" width="400px">
                        </p>

                        </br>
                        <!--‘ Minimal and Reliable Guides to growing Magical Mushrooms.-->
                    </div>
                    <!-- When you mess up badly but on THE Internet it’s top class.-->
                </div>
...
if ($level_no == $row['level']) {
    ?>
    <form action="level7.php" method="post" style="z-index: 999999999; width: 100%; position: absolute;">
        <label>
        ...
        <input type="submit" value="Отправить" role="button" class="btn btn-primary trans" style="font-size: 18px">
    </form>
