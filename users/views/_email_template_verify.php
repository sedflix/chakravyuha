...
<html>
  <head>
    <meta charset="utf-8">
    <title>Chakravyuha Verification</title>
  </head>
  <body>
    <p>Congratulations <?=$fname;?>,</p>
    <p>Welcome to Esya'16, thanks for signing up for Chakravyuha. Please click the link below to verify your email address.</p>
