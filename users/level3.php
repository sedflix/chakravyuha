            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12"> </br>
                        ...
                        <p class="text-center">
                            <img src="http://www.clipartbest.com/cliparts/dir/ek4/direk47i9.jpeg" class="img-responsive img-thumbnail center-block" height="350px" width="350px">
                        </p>
                        ...
                        <!--- In spacing terms, the bigger one always wins.-->
                </div>
...
if ($level_no == $row['level']) {
    ?>
    <form action="level3.php" method="post" style="z-index: 999999999; width: 100%; position: absolute;">
        <label>
