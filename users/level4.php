...
$level_no = 4;
$correctAns = "didyoumeanrecursion";
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12"> </br>
                        ...
                        <p class="text-center">
                            The answer is <a href = "http://goo.gl/01L2G7">here</a>.
                        </p>

                        </br>

                        <!--The answer isn't here, it's on the screen.-->
                    </div>
...
if ($level_no == $row['level']) {
    ?>
    <form action="level4.php" method="post" style="z-index: 999999999; width: 100%; position: absolute;">
        <label>
