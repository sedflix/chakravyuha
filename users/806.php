            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12"> </br>
                        ...
                        <h1 class="text-center">L3v3l 6</h1>
                        ...
                        <p class="text-center">
                            <img src="http://pngimg.com/upload/corn_PNG5273.png" class="img-responsive img-thumbnail center-block" height="600px" width="460px">
                        </p>

                        </br>

                        <!--Only 90s kids in Israel could call Uncle Munroe.-->
                    </div>
...
if ($level_no == $row['level']) {
    ?>
    <form action="806.php" method="post" style="z-index: 999999999; width: 100%; position: absolute;">
        <label>
        ...
        <input type="submit" role="button" value="subm1t" class="btn btn-primary trans" style="font-size: 18px">
    </form>
