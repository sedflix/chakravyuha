...
$level_no = 2;
$correctAns = "wedidnotinventthealgorithmthealgorithmconsistentlyfindsjesusthealgorithmkilledjeevesthealgorithmisbannedinchinathealgorithmisfromjerseythealgorithmconstantlyfindsjesusthisisnotthealgorithmthisisclose";
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12"> </br>
                        ...
                        <p class="text-center">
                            ...
                            The power of the algorithm. Thou can’t pronounce where it is. Salvation!

                        </p>

                        </br>

                        <!--This is the closest you’re gonna get. If you’re in China, it's illegal. Oops. -->
                    </div>

                </div>

			<!--Murderer of the gentleman-->
            </div>
...
if ($level_no == $row['level']) {
    ?>
    <form action="level2.php" method="post" style="z-index: 999999999; width: 100%; position: absolute;">
        <label>
